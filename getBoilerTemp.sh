 ...
 #rotate and crop the picture and save the output as ready4ocr.jpeg
 convert saved-photo.jpeg -rotate 269 -brightness-contrast -70,0 -crop 1000x500+325+425 -colorspace gray ready4ocr.jpeg

 #use textcleaner.sh => makes it easier for the ocr
 ./textcleaner.sh -c 0,0,100,0 ready4ocr.jpeg after-textcleaner.jpeg
 #get the boiler temp from the picture with ssocr
 boilerTemp=$(ssocr/ssocr -d 3 after-textcleaner.jpeg)
